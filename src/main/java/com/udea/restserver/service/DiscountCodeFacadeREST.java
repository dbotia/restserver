...
import com.udea.restserver.modelo.DiscountCode;
 ...
 */
@Stateless
@Path("com.udea.restserver.modelo.discountcode")
public class DiscountCodeFacadeREST extends AbstractFacade<DiscountCode> {

    @PersistenceContext(unitName = "com.udea_RESTServer_war_1.0-SNAPSHOTPU")
